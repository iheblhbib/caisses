...
// $('tbody').click(function(){ window.location = "caisse.php"; })
//    })
    </script>
 <body>
  <br />
...
<div class="panel panel-default">
             ...
             <center>            
<div id="order_date" name="order_date" style="width: 200px;">
  <form action="caisse.php" method="get">
      ...
      <button type="submit" class="btn btn-primary">Visualiser</button>
       ...
       <div class="row">
 <center>
<a class="btn btn-primary" href="invoice.php" role="button">Résultat/Mois</a>
<a class="btn btn-primary" href="ping.php" role="button">Listes des articles</a>
<!--a class="btn btn-primary" href="chargemensuel.php?add=1" role="button">Charges Mensuelles</a-->
<a class="btn btn-primary" href="historique.php" role="button">Historique</a>
<a class="btn btn-primary" href="chargejour.php" role="button">Charges</a>
<a class="btn btn-primary" href="add_user.php" role="button">Ajout Utilisateur</a>
