<?php
 ...
 //include ('pdf.php');
  ...
  $statement = $connect->prepare(" 
    SELECT *  FROM tbl_order_item where created=CURRENT_DATE() and item_name<>'';
  ");
...
<div id="html-2-pdfwrapper">
 ...
 <table class="table table-bordered">
          <div align="center">
    <input align="center" type="text" name="order_date" id="order_date" class="form-control input-sm" style="background-color:#9400D3; color: #FDFEFE; font-size:30px; text-align: center; width: 20%;" readonly />
